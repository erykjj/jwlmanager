...
################################################################################
## Form generated from reading UI file 'main_windowevejHT.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u"ui/icons/project_36.ico", QSize(), QIcon.Normal, QIcon.Off)
        MainWindow.setWindowIcon(icon)
        MainWindow.setUnifiedTitleAndToolBarOnMac(False)
        self.actionOpen = QAction(MainWindow)
        self.actionOpen.setObjectName(u"actionOpen")
        icon1 = QIcon()
        icon1.addFile(u"ui/icons/icons8-opened-folder-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionOpen.setIcon(icon1)
        self.actionSave = QAction(MainWindow)
        self.actionSave.setObjectName(u"actionSave")
        self.actionSave.setEnabled(False)
        icon2 = QIcon()
        icon2.addFile(u"ui/icons/icons8-save-64.png", QSize(), QIcon.Normal, QIcon.On)
        self.actionSave.setIcon(icon2)
        self.actionImport = QAction(MainWindow)
        self.actionImport.setObjectName(u"actionImport")
        self.actionImport.setEnabled(False)
        icon3 = QIcon()
        icon3.addFile(u"ui/icons/icons8-download-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"ui/icons/icons8-database-administrator-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionReindex.setIcon(icon4)
        self.actionQuit = QAction(MainWindow)
        self.actionQuit.setObjectName(u"actionQuit")
        icon5 = QIcon()
        icon5.addFile(u"ui/icons/icons8-export-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionQuit.setIcon(icon5)
        self.actionAbout = QAction(MainWindow)
        self.actionAbout.setObjectName(u"actionAbout")
        icon6 = QIcon()
        icon6.addFile(u"ui/icons/icons8-info-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionAbout.setIcon(icon6)
        self.actionHelp = QAction(MainWindow)
        self.actionHelp.setObjectName(u"actionHelp")
        self.actionHelp.setEnabled(True)
        icon7 = QIcon()
        icon7.addFile(u"ui/icons/icons8-help-64.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionHelp.setIcon(icon7)
        self.actionSave_As = QAction(MainWindow)
        self.actionSave_As.setObjectName(u"actionSave_As")
        self.actionSave_As.setEnabled(False)
        icon8 = QIcon()
        icon8.addFile(u"ui/icons/icons8-save-as-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(u"ui/icons/icons8-expand-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u"ui/icons/icons8-collapse-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u"ui/icons/icons8-double-tick-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(u"ui/icons/icons8-unchecked-checkbox-64.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(u"ui/icons/icons8-list-64.png", QSize(), QIcon.Normal, QIcon.On)
