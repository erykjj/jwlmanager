...
[^*]: Available: Deutsch, English, español, français, italiano, Polski, Português, Pусский, українська; help with translation to other languages also welcome. [![Translation status](https://hosted.weblate.org/widget/jwlmanager/language-badge.svg)](https://hosted.weblate.org/engage/jwlmanager/) [![Translation status](https://hosted.weblate.org/widget/jwlmanager/svg-badge.png)](https://hosted.weblate.org/engage/jwlmanager/)
