...
### View (button)
######
Shows selected Notes and Annotations in a **Data Viewer** window, with a filter that searches within the title and body. There, you can delete and/or edit individual items. You have to confirm all edits within the **Data Editor** and *again* in the Data Viewer before they are written to the database (of course, you still have to save the archive as usual). You can go back via the buttons (or `Escape` key) without affecting the database.
#####
######
### Add
######
