...
################################################################################
## Form generated from reading UI file 'main_windowXKHVOQ.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(self.resource_path('res/icons/project_72.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        MainWindow.setWindowIcon(icon)
        MainWindow.setUnifiedTitleAndToolBarOnMac(False)
        self.actionOpen = QAction(MainWindow)
        self.actionOpen.setObjectName(u"actionOpen")
        icon1 = QIcon()
        icon1.addFile(self.resource_path('../../res/icons/icons8-opened-folder-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionOpen.setIcon(icon1)
        self.actionSave = QAction(MainWindow)
        self.actionSave.setObjectName(u"actionSave")
        self.actionSave.setEnabled(False)
        icon2 = QIcon()
        icon2.addFile(self.resource_path('../../res/icons/icons8-save-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon2.addFile(self.resource_path('../../res/icons/icons8-save-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon3 = QIcon()
        icon3.addFile(self.resource_path('../../res/icons/icons8-database-administrator-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionReindex.setIcon(icon3)
        self.actionQuit = QAction(MainWindow)
        self.actionQuit.setObjectName(u"actionQuit")
        icon4 = QIcon()
        icon4.addFile(self.resource_path('../../res/icons/icons8-leave-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionQuit.setIcon(icon4)
        self.actionAbout = QAction(MainWindow)
        self.actionAbout.setObjectName(u"actionAbout")
        icon5 = QIcon()
        icon5.addFile(self.resource_path('../../res/icons/icons8-info-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionAbout.setIcon(icon5)
        self.actionHelp = QAction(MainWindow)
        self.actionHelp.setObjectName(u"actionHelp")
        self.actionHelp.setEnabled(True)
        icon6 = QIcon()
        icon6.addFile(self.resource_path('../../res/icons/icons8-help-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionHelp.setIcon(icon6)
        self.actionSave_As = QAction(MainWindow)
        self.actionSave_As.setObjectName(u"actionSave_As")
        self.actionSave_As.setEnabled(False)
        icon7 = QIcon()
        icon7.addFile(self.resource_path('../../res/icons/icons8-save-as-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(self.resource_path('../../res/icons/icons8-expand-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(self.resource_path('../../res/icons/icons8-collapse-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(self.resource_path('../../res/icons/icons8-double-tick-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(self.resource_path('../../res/icons/icons8-unchecked-checkbox-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(self.resource_path('../../res/icons/icons8-add-file-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(self.resource_path('../../res/icons/icons8-invisible-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.actionZH = QAction(MainWindow)
        self.actionZH.setObjectName(u"actionZH")
        self.actionZH.setCheckable(True)
        self.actionSort = QAction(MainWindow)
        self.actionSort.setObjectName(u"actionSort")
        self.actionSort.setEnabled(False)
        icon14 = QIcon()
        icon14.addFile(self.resource_path('../../res/icons/icons8-ascending-sorting-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon15 = QIcon()
        icon15.addFile(self.resource_path('../../res/icons/icons8-list-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon16 = QIcon()
        icon16.addFile(self.resource_path('../../res/icons/icons8-language-64.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menuLanguage.setIcon(icon16)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionZH.setText(QCoreApplication.translate("MainWindow", u"\u4e2d\u6587", None))
        self.actionZH.setToolTip(QCoreApplication.translate("MainWindow", u"zh", None))
