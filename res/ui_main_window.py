...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow, theme):
        ...
        icon1 = QIcon()
        icon1.addFile(self.resource_path(f'res/icons/{theme}/open.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionOpen.setIcon(icon1)
        self.actionSave = QAction(MainWindow)
        self.actionSave.setObjectName(u"actionSave")
        self.actionSave.setEnabled(False)
        icon2 = QIcon()
        icon2.addFile(self.resource_path(f'res/icons/{theme}/save-disabled.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon2.addFile(self.resource_path(f'res/icons/{theme}/save.png'), QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon3 = QIcon()
        icon3.addFile(self.resource_path(f'res/icons/{theme}/database.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionReindex.setIcon(icon3)
        self.actionQuit = QAction(MainWindow)
        self.actionQuit.setObjectName(u"actionQuit")
        icon4 = QIcon()
        icon4.addFile(self.resource_path(f'res/icons/{theme}/leave.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionQuit.setIcon(icon4)
        self.actionAbout = QAction(MainWindow)
        self.actionAbout.setObjectName(u"actionAbout")
        icon5 = QIcon()
        icon5.addFile(self.resource_path(f'res/icons/{theme}/info.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionAbout.setIcon(icon5)
        self.actionHelp = QAction(MainWindow)
        self.actionHelp.setObjectName(u"actionHelp")
        self.actionHelp.setEnabled(True)
        icon6 = QIcon()
        icon6.addFile(self.resource_path(f'res/icons/{theme}/help.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionHelp.setIcon(icon6)
        self.actionSave_As = QAction(MainWindow)
        self.actionSave_As.setObjectName(u"actionSave_As")
        self.actionSave_As.setEnabled(False)
        icon7 = QIcon()
        icon7.addFile(self.resource_path(f'res/icons/{theme}/save-as.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon8 = QIcon()
        icon8.addFile(self.resource_path(f'res/icons/{theme}/expand.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon9 = QIcon()
        icon9.addFile(self.resource_path(f'res/icons/{theme}/collapse.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(self.resource_path(f'res/icons/{theme}/double-tick.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(self.resource_path(f'res/icons/{theme}/unchecked.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon12 = QIcon()
        icon12.addFile(self.resource_path(f'res/icons/{theme}/add-file.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(self.resource_path(f'res/icons/{theme}/invisible.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon14 = QIcon()
        icon14.addFile(self.resource_path(f'res/icons/{theme}/sort.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon15 = QIcon()
        icon15.addFile(self.resource_path(f'res/icons/{theme}/list.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon16 = QIcon()
        icon16.addFile(self.resource_path(f'res/icons/{theme}/language.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
