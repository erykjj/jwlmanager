...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow, theme):
        ...
        icon = QIcon()
        icon.addFile(self.resource_path(f'res/icons/{theme}/JWLManager.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon2 = QIcon()
        icon2.addFile(self.resource_path(f'res/icons/{theme}/save.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon15 = QIcon()
        icon15.addFile(self.resource_path(f'res/icons/{theme}/toggle.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionTheme.setIcon(icon15)
        ...
        icon16 = QIcon()
        icon16.addFile(self.resource_path(f'res/icons/{theme}/list.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.menuTitle_View.setIcon(icon16)
        self.menuTitle_View.setToolTipsVisible(True)
        self.menuLanguage = QMenu(self.menuView)
        self.menuLanguage.setObjectName(u"menuLanguage")
        icon17 = QIcon()
        icon17.addFile(self.resource_path(f'res/icons/{theme}/language.png'), QSize(), QIcon.Mode.Normal, QIcon.State.Off)
