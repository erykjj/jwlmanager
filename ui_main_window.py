...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QIcon()
        icon2.addFile(self.resource_path('icons/icons8-opened-folder-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        self.actionOpen.setIcon(icon2)
        self.actionSave = QAction(MainWindow)
        self.actionSave.setObjectName(u"actionSave")
        self.actionSave.setEnabled(False)
        icon3 = QIcon()
        icon3.addFile(self.resource_path('icons/icons8-save-64.png'), QSize(), QIcon.Normal, QIcon.On)
        self.actionSave.setIcon(icon3)
        self.actionImport = QAction(MainWindow)
        self.actionImport.setObjectName(u"actionImport")
        self.actionImport.setEnabled(False)
        icon4 = QIcon()
        icon4.addFile(self.resource_path('icons/icons8-download-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(self.resource_path('icons/icons8-database-administrator-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        self.actionReindex.setIcon(icon5)
        self.actionQuit = QAction(MainWindow)
        self.actionQuit.setObjectName(u"actionQuit")
        icon6 = QIcon()
        icon6.addFile(self.resource_path('icons/icons8-export-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        self.actionQuit.setIcon(icon6)
        self.actionAbout = QAction(MainWindow)
        self.actionAbout.setObjectName(u"actionAbout")
        icon7 = QIcon()
        icon7.addFile(self.resource_path('icons/icons8-info-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        self.actionAbout.setIcon(icon7)
        self.actionHelp = QAction(MainWindow)
        self.actionHelp.setObjectName(u"actionHelp")
        self.actionHelp.setEnabled(True)
        icon8 = QIcon()
        icon8.addFile(self.resource_path('icons/icons8-help-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        self.actionHelp.setIcon(icon8)
        self.actionSave_As = QAction(MainWindow)
        self.actionSave_As.setObjectName(u"actionSave_As")
        self.actionSave_As.setEnabled(False)
        icon9 = QIcon()
        icon9.addFile(self.resource_path('icons/icons8-save-as-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(self.resource_path('icons/icons8-expand-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        self.actionExpand_All.setIcon(icon10)
        ...
        icon11 = QIcon()
        icon11.addFile(self.resource_path('icons/icons8-collapse-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        self.actionCollapse_All.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(self.resource_path('icons/icons8-double-tick-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon13 = QIcon()
        icon13.addFile(self.resource_path('icons/icons8-unchecked-checkbox-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        self.actionUnselect_All.setIcon(icon13)
        ...
        icon14 = QIcon()
        icon14.addFile(self.resource_path('icons/icons8-add-file-64.png'), QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.button_export.setGeometry(QRect(530, 10, 86, 26))
